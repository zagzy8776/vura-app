...
export class BankCodesService {
  ...
  private readonly banks: Record<string, BankInfo> = {
    // Major Banks - Paystack
    '044': { code: '044', name: 'Access Bank', provider: 'paystack' },
    '011': {
      code: '011',
    ...
    '057': { code: '057', name: 'Zenith Bank', provider: 'paystack' },
    '033': {
      code: '033',
    ...
    '035': { code: '035', name: 'Wema Bank', provider: 'paystack' },
    '232': { code: '232', name: 'Sterling Bank', provider: 'paystack' },

    // Other Commercial Banks
    '023': { code: '023', name: 'Citibank Nigeria', provider: 'paystack' },
    '050': { code: '050', name: 'Ecobank Nigeria', provider: 'paystack' },
    '214': {
      code: '214',
      name: 'First City Monument Bank (FCMB)',
      provider: 'paystack',
    },
    '070': { code: '070', name: 'Fidelity Bank', provider: 'paystack' },
    '030': { code: '030', name: 'Heritage Bank', provider: 'paystack' },
    '301': { code: '301', name: 'Jaiz Bank', provider: 'paystack' },
    '082': { code: '082', name: 'Keystone Bank', provider: 'paystack' },
    '076': { code: '076', name: 'Polaris Bank', provider: 'paystack' },
    '221': { code: '221', name: 'Stanbic IBTC Bank', provider: 'paystack' },
    '068': {
      code: '068',
      name: 'Standard Chartered Bank',
      provider: 'paystack',
    },
    '215': { code: '215', name: 'Unity Bank', provider: 'paystack' },
    '100': { code: '100', name: 'SunTrust Bank', provider: 'paystack' },
