...
export class BankCodesService {
  ...
  private readonly banks: Record<string, BankInfo> = {
    ...
    '999': { code: '999', name: 'Kuda Bank', provider: 'both' },
    '502': { code: '502', name: 'PalmPay', provider: 'monnify' },
    '503': { code: '503', name: 'OPay', provider: 'monnify' },
    '505': { code: '505', name: 'Moniepoint', provider: 'monnify' },
    '512': { code: '512', name: 'Carbon (Paylater)', provider: 'monnify' },
    '513': { code: '513', name: 'Interswitch', provider: 'monnify' },
    '514': { code: '514', name: 'Flutterwave', provider: 'monnify' },
    '526': { code: '526', name: 'Paga', provider: 'monnify' },
    '560': { code: '560', name: 'Branch', provider: 'monnify' },
    '602': { code: '602', name: 'FSDH', provider: 'monnify' },
    '610': { code: '610', name: 'Covenant', provider: 'monnify' },
    '612': { code: '612', name: 'Zinternet', provider: 'monnify' },
    '613': { code: '613', name: 'Daylight', provider: 'monnify' },
    '614': { code: '614', name: 'Titan Trust', provider: 'monnify' },
    '615': { code: '615', name: 'Nigerian Navy', provider: 'monnify' },
    '616': { code: '616', name: 'NIBSS', provider: 'monnify' },
    '617': { code: '617', name: 'eTranzact', provider: 'monnify' },
    '618': { code: '618', name: 'Providus Bank', provider: 'monnify' },
    '619': { code: '619', name: 'Sterling Alternative Bank', provider: 'monnify' },
    '620': { code: '620', name: 'Parallex Bank', provider: 'monnify' },
    '621': { code: '621', name: 'Repo', provider: 'monnify' },
    '622': { code: '622', name: 'Gozem', provider: 'monnify' },
    '623': { code: '623', name: 'Migo', provider: 'monnify' },
    '624': { code: '624', name: 'Teasy', provider: 'monnify' },
    '625': { code: '625', name: 'Gomoney', provider: 'monnify' },
    '626': { code: '626', name: 'BancABC', provider: 'monnify' },
    '627': { code: '627', name: 'UBN', provider: 'monnify' },
    '628': { code: '628', name: 'Globus Bank', provider: 'monnify' },
    '629': { code: '629', name: 'EcoBank', provider: 'monnify' },
    '630': { code: '630', name: 'Fortress', provider: 'monnify' },
    '631': { code: '631', name: 'Premium Trust', provider: 'monnify' },
    '632': { code: '632', name: 'VFD', provider: 'monnify' },
    '633': { code: '633', name: 'Mkudi', provider: 'monnify' },
    '634': { code: '634', name: 'Rhomax', provider: 'monnify' },
    '635': { code: '635', name: 'Kredi Bank', provider: 'monnify' },
  };
